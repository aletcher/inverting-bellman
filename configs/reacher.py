...
VI_STATE_DIM = 4
VI_STATE_RANGES = STATE_RANGES[:VI_STATE_DIM]
...
WM_TRAJECTORY_GOAL_INDICES = [0, 1, 2, 3] # Which goals to overlay on the trajectory_policy plot.
