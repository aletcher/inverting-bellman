...
Codebase for the paper *Inverting the Bellman Equation: From Q-Values to World Models* using a JAX implementation of **P-learning**: extracting the world model contained in an agent's Q-values.
